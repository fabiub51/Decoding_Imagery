...
% Top-level folder 
data_dir = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-0';

%smoothing images 8x8x8mm
smoothing_stim(data_dir, length(subs));
smoothing_imag(data_dir, length(subs));
...
output_dir_stim = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_analysis';
specification_2nd_level_stim(output_dir_stim, data_dir, subs);

% Specification - imagery
mkdir 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag'
output_dir_imag = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag';
specification_2nd_level_imag(output_dir_imag, data_dir, subs);

% Estimation - stimulus and imagery
estimation_stim(output_dir_stim);
estimation_imag(output_dir_imag);

% Simple t-contrast for stimulus and imagery
one_sample_t_contrast(output_dir_stim) % stimulus
one_sample_t_contrast(output_dir_imag) % imagery
...
for i = 1:size(matrix_participant_leave_one_out,1)
    output_dir_stim = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_analysis\map_',num2str(i));
    specification_2nd_level_stim(output_dir_stim, data_dir, matrix_participant_leave_one_out(i,:));
end

% Specification - imagery
for i = 1:size(matrix_participant_leave_one_out,1)
    output_dir_imag = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag\map_',num2str(i));
    specification_2nd_level_imag(output_dir_imag, data_dir, matrix_participant_leave_one_out(i,:));
end
...
for i = 1:size(matrix_participant_leave_one_out,1)
    output_dir_imag = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag\map_',num2str(i));
    estimation_stim(output_dir_imag);
end

% Contrast t-contrast for stimulus and imagery
for i = 1:size(matrix_participant_leave_one_out,1)
    output_dir_stim = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_analysis\map_',num2str(i));
    one_sample_t_contrast(output_dir_stim);
end

% Contrast - imagery 
for i = 1:size(matrix_participant_leave_one_out,1)
    output_dir_imag = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag\map_',num2str(i));
    one_sample_t_contrast(output_dir_imag);
end
