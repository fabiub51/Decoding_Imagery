...
if sub_no < 10
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00',num2str(sub_no),'\results_decoding_imag');
else
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-0',num2str(sub_no),'\results_decoding_imag');
end
...
labelnames1  = 'ImagPress';
labelnames2  = 'ImagFlutt';
labelnames3  = 'ImagVibro';
...
% choose decoding software (default: libsvm):
